#!/usr/bin/env sh
# Universal installer for cloudbill. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cloudbill.git"
echo "Installing cloudbill ..."
