"""CLOUDBILL core — Multi-cloud cost report, anomaly detection, and FOCUS export."""
...
RULES = [
    ("CLO-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("CLO-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("CLO-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
